      ...
      >
        <div className="bg-[#0a0f1e] border border-white/5 p-8 rounded-2xl shadow-2xl backdrop-blur-sm">
          ...
          <button
            ...
            className="w-full bg-white/5 border border-white/10 text-white font-medium py-3 rounded-xl hover:bg-white/10 transition-colors flex items-center justify-center gap-2"
          >
